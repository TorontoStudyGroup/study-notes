...
<InterviewQuestion
title="Warm-up Q"
prompt="Explain how consistent hashing with virtual nodes enables automatic scaling when adding/removing machines."
/>

<InterviewQuestion
title="Design Choice Q"
prompt="With N=3, would you choose (W=1,R=3) or (W=2,R=2) for a social feed write path? Why?"
/>

<InterviewQuestion
title="Failure Handling Q"
prompt="During a partition, how do sloppy quorum and hinted handoff preserve availability without losing data placement guarantees?"
/>

<InterviewQuestion
title="Storage Q"
prompt="Walk through the LSM-tree write/read paths. Why are writes fast and what does compaction trade off?"
/>
