...
![Single Server Architecture](./images/ch1/ch1-1.png)

Request process diagram:

![Single Server Request Process](./images/ch1/ch1-2.png)
...
![Database Architecture](./images/ch1/ch1-3.png)
...
![Load Balancer Architecture](./images/ch1/ch1-4.png)
...
![Database Replication Architecture](./images/ch1/ch1-5.png)
...
![Database Replication Architecture With Load Balancer](./images/ch1/ch1-6.png)
...
![CDN Architecture](./images/ch1/ch1-7.png)
...
![Stateful Architecture](./images/ch1/ch1-8.png)
...
![Message Queue Architecture](./images/ch1/ch1-12.png)
...
![Logging, Metrics, Automation Architecture](./images/ch1/ch1-13.png)

## Database Scaling

![Database Scaling](./images/ch1/ch1-14.png)
